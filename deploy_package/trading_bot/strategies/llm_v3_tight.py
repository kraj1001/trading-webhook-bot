"""
LLM v3 Tight Strategy
Verified: Optimized for volatile markets with tighter stops
...
class LLMv3TightStrategy(BaseStrategy):
    """
    LLM v3 Tight Strategy (LONG + SHORT)
    Same entry logic as v4, but with tighter stops/TPs
    ...
    def __init__(self, symbol: str = "XRPUSDT", timeframe: str = "4h"):
        super().__init__("LLM_v3_Tight", symbol, timeframe)
        self.atr_stop = 0.8  # Tighter stop (v4 was 1.0)
        self.atr_tp = 1.5    # Tighter TP (v4 was 2.0)
        self.adx_min = 25
    ...
    def check_entry(self, df: pd.DataFrame) -> Optional[Signal]:
        ...
        if long_trend and long_price and long_rsi and long_macd and adx_ok and volume_ok:
            ...
            return Signal(
                ...
                reason="LONG (Tight): EMA15>30>200, RSI>70, ADX>25, MACD+"
            )
        ...
        if short_trend and short_price and short_rsi and short_macd and adx_ok and volume_ok:
            ...
            return Signal(
                ...
                quantity=0,
                timestamp=datetime.now(),
                reason="SHORT (Tight): EMA15<30<200, RSI<30, ADX>25, MACD-"
            )
